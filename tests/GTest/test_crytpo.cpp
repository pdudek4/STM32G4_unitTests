...
TEST(CRYPTO_test, test_CRYPTO_decryptBlockWithSecretKey_withoutInitSecretKey)
{
	int8_t retVal;
...
TEST(CRYPTO_test, test_CRYPTO_decryptBlockWithSecretKey)
{
	int8_t retVal;
	uint8_t privateKey[16]    = { 0x9C, 0x8A, 0x50, 0xCD, 0xFC, 0xFD, 0x91, 0x60, 0xF5, 0xD4, 0x21, 0xBF, 0x8F, 0xD5, 0x72, 0x95};
	uint8_t privateKeyRef[16] = { 0x67, 0xC6, 0x69, 0x73, 0x51, 0xFF, 0x4A, 0xEC, 0x29, 0xCD, 0xBA, 0xAB, 0xF2, 0xFB, 0xE3, 0x46};
...
TEST(CRYPTO_test, test_CRYPTO_decryptBlockWithPrivateKey_withoutInitPrivateKey)
{
	int8_t retVal;
...
TEST(CRYPTO_test, test_CRYPTO_decryptBlockWithPrivateKey)
{
	int8_t retVal;
	uint8_t bootPassword[16] = { 0xBE, 0x73, 0x23, 0xB8, 0xB1, 0x55, 0xA9, 0x99, 0x1E, 0x6F, 0x05, 0x2B, 0x79, 0xD0, 0xBF, 0x3D};
